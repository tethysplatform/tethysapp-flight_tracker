...
class FlightTrackerTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(FlightTracker)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(FlightTracker)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/flight-tracker/')  # The final '/' is essential for all pages/controllers
